<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_manager_role_list" Codebehind="role_list.aspx.cs" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="role_edit.aspx?action=edit&id=<%#Eval("id")%>"><%#Eval("role_name")%></a></td>
    <td><%#GetTypeName( Convert.ToInt32(Eval("role_type")))%></td>
    <td align="center">
     <asp:LinkButton ID="lbedit" runat="server" CommandArgument='<%#Eval("id")%>' 
    oncommand="lbedit_Command">编辑</asp:LinkButton>
   </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
