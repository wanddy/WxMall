<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_settings_Column_list" Codebehind="Column_list.aspx.cs" %>
...
<ItemTemplate>
  <tr>
    <td align="center">
      ...
      <asp:HiddenField ID="hidId" Value='<%#Eval("classid")%>' runat="server" />
    ...
    <td style="white-space:nowrap;word-break:break-all;overflow:hidden;"><%#Eval("classid")%></td>
    <td style="white-space:nowrap;word-break:break-all;overflow:hidden;">
      <asp:Literal ID="LitFirst" runat="server"></asp:Literal>
        <%#Eval("classname")%>
    </td>
    <td align="center"><%#Eval("isShowChannel").ToString() == "0" ? "否" : "是"%></td>
    <td align="center"><%#GetClassAttrbute(Eval("modelId").ToString())%></td>
    <td><asp:TextBox ID="ordernumber" runat="server" Text='<%#Eval("ordernumber")%>' CssClass="sort" onkeydown="return checkNumber(event);" /></td>
    <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
      <asp:LinkButton ID="lbadd" runat="server" CommandArgument='<%#Eval("classid")%>' 
    oncommand="lbadd_Command">添加子级</asp:LinkButton>
      <asp:LinkButton ID="lbedit" runat="server" CommandArgument='<%#Eval("classid")%>' 
