<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_settings_Column_edit"
    ValidateRequest="false" EnableEventValidation="false" Codebehind="Column_edit.aspx.cs" %>
        ...
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    ...
                    <%--<li><a href="javascript:;" onclick="tabs(this);">手机站设置</a></li>
                    <li><a href="javascript:;" onclick="tabs(this);">英文站设置</a></li>--%>
                </ul>
            </div>
        </div>
    </div>
        ...
        <dl>
            ...
            <dd>
                <asp:TextBox ID="txtCallIndex" runat="server" CssClass="input normal" datatype="/^\s*$|^[a-zA-Z0-9\-\_]{2,50}$/"
                    errormsg="请填写正确的别名" sucmsg=" "></asp:TextBox>
        ...
        <dl>
            ...
            <dd>
                <asp:TextBox ID="linkUrl" runat="server" CssClass="input normal" datatype="*0-100"
                    sucmsg=" "></asp:TextBox><asp:Label ID="Label7" runat="server" CssClass="Validform_checktip" />
