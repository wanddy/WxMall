<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_settings_channel_edit"
    ValidateRequest="false" EnableEventValidation="false" Codebehind="channel_edit.aspx.cs" %>
...
<body class="mainbody">
    ...
    <div class="content-tab-wrap">
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a href="javascript:;" onclick="tabs(this);" class="selected">基本设置</a></li>
                    <li><a href="javascript:;" onclick="tabs(this);">高级设置</a></li>
                    <li runat="server" visible="false"><a href="javascript:;" onclick="tabs(this);">手机站设置</a></li>
                    <li runat="server" visible="false"><a href="javascript:;" onclick="tabs(this);">英文站设置</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    <asp:DropDownList ID="modelId" runat="server">
        ...
        <dl>
            ...
            <dd>
                ...
                <asp:Label ID="classid" runat="server" Text="Label" Visible="false"></asp:Label>
