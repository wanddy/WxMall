...
public partial class Admin_settings_Column_list : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        JscriptMsg("保存排序成功！", "Column_list.aspx", "Success");
    }
    #endregion
    ...
    {
        Response.Redirect("Column_edit.aspx?action=add");
    }
    protected void lbadd_Command(object sender, CommandEventArgs e)
    {
        string cid = e.CommandArgument.ToString();
        Response.Redirect("Column_edit.aspx?action=add&classid=" + cid + "");
    }
    protected void lbedit_Command(object sender, CommandEventArgs e)
    {
        string cid = e.CommandArgument.ToString();
        Response.Redirect("Column_edit.aspx?action=edit&classid=" + cid + "");
    }
