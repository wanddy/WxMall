<%@ Page Language="C#" AutoEventWireup="true" Inherits="CReplylist" Codebehind="CReplylist.aspx.cs" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="center" width="8%">URL</th>
    <th align="center" width="8%">是否开通</th>
    <th align="center" width="4%">更新时间</th>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><%# typename(Eval("typeid").ToString())%></a></td>
    <td align="center"><%#Eval("title")%></a></td>
    <td align="center"><%#Eval("url")%></a></td>
    <td align="center"><%#Eval("isopen").ToString()=="1"?"是":"否"%></td>
    ...
    <td align="center"><asp:LinkButton ID="lbedit" runat="server" CommandArgument='<%#Eval("id")%>'  oncommand="lbedit_Command">修改</asp:LinkButton>
        <asp:LinkButton ID="lbopen" runat="server" CommandArgument='<%#Eval("id")%>'  oncommand="lbopen_Command"><%# Convert.ToInt32(Eval("isopen")) == 1 ? "取消开通" : "设置开通"%></asp:LinkButton>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
