<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_wx_wenBenList" Codebehind="wenBenList.aspx.cs" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="editWenBen.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>添加文本回复</span></a></li>
