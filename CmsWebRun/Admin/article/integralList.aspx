<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_article_integralList" Codebehind="integralList.aspx.cs" %>
    ...
    <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="integralEdit.aspx?action=edit&articleId=<%#Eval("articleId")%>&classid=<%#Eval("parentId")%>">
                        <%#Eval("title")%></a>
                </td>
                <td>
                ...
                <ItemTemplate>
                    <li>
                        <div class="details<%#Eval("photoUrl").ToString() != "" ? "" : " nopic"%>">
                            ...
                            <h1>
                                <span><a href="integralEdit.aspx?action=edit&articleId=<%#Eval("articleId")%>&classid=<%#Eval("parentId")%>">
