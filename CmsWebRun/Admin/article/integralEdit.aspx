<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_article_integralEdit" ValidateRequest="false" EnableEventValidation="false" EnableViewState="true" Codebehind="integralEdit.aspx.cs" %>
...
<body class="mainbody">
    ...
    <div class="tab-content">
        ...
        <dl id="Dl2" runat="server" visible="false">
            <dt>文章作者</dt>
            <dd>
        ...
        <dl id="Dl3" runat="server" visible="false">
            <dt>上传附件</dt>
            <dd>
    ...
    <div class="tab-content" style="display: none">
        ...
        <dl>
            <dt>兑换所需积分</dt>
            <dd>
                <asp:TextBox ID="userscore" runat="server" CssClass="input normal" datatype="n"
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    <asp:DropDownList ID="type" runat="server" datatype="*" sucmsg=" ">
            ...
            <dt>款号</dt>
            <dd>
                <asp:TextBox ID="style" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
            <dt>金重</dt>
            <dd>
                <asp:TextBox ID="kim_joong" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                克<span class="Validform_checktip">数字</span>
            </dd>
        </dl>
        <dl>
            <dt>寸数</dt>
            <dd>
                <asp:TextBox ID="inch_number" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                 寸<span class="Validform_checktip">数字</span>
            </dd>
        </dl>
        <dl>
            <dt>金价</dt>
            <dd>
                <asp:TextBox ID="gold_price" runat="server" CssClass="input normal" datatype="pirce" sucmsg=" "></asp:TextBox>
        ...
        <dl>
            <dt>工费</dt>
            <dd>
                <asp:TextBox ID="labor_charges" runat="server" CssClass="input normal" datatype="pirce" sucmsg=" "></asp:TextBox>
                元<span class="Validform_checktip">格式0.00</span>
            </dd>
        </dl>
        <dl>
            <dt>颜色</dt>
            <dd>
                <div class="rule-multi-radiocolor">
                        <asp:RadioButtonList ID="color" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                 ...
                 <div class="rule-multi-radioclarity">
                        <asp:RadioButtonList ID="clarity"  runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                 ...
                 <div class="rule-multi-radiocut">
                        <asp:RadioButtonList ID="cut" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
         <dl>
            ...
            <dd>
                 ...
                 <div class="rule-multi-radioshape">
                        <asp:RadioButtonList ID="diamond_shape" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                 ...
                 <div class="rule-multi-radiomaterial">
                        <asp:RadioButtonList ID="material" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                 ...
                 <div class="rule-multi-radiobstype">
                        <asp:RadioButtonList ID="bstype" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                 ...
                 <div class="rule-multi-radiopintype">
                        <asp:RadioButtonList ID="pintype" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
            </dd>
        </dl>
          <dl>
            <dt>主石重</dt>
            <dd>
                <asp:TextBox ID="main_stone_weight" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" ">0.00</asp:TextBox>
                克拉<span class="Validform_checktip">数字</span>
            </dd>
        </dl>
        <dl>
            <dt>主石数量</dt>
            <dd>
                <asp:TextBox ID="main_stone_number" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
               颗<span class="Validform_checktip">数字</span>
            </dd>
        </dl>
        <dl>
            <dt>总重</dt>
            <dd>
                <asp:TextBox ID="total_weight" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" ">0.00</asp:TextBox>
                克<span class="Validform_checktip">数字</span>
            </dd>
        </dl>
        <dl>
            <dt>销售工费</dt>
            <dd>
                <asp:TextBox ID="sales_labor_charge" runat="server" CssClass="input normal" datatype="pirce" sucmsg=" "></asp:TextBox>
               元<span class="Validform_checktip">格式0.00</span>
            </dd>
        </dl>
        <dl>
            <dt>配件价</dt>
            <dd>
                <asp:TextBox ID="accessories_price" runat="server" CssClass="input normal" datatype="pirce" sucmsg=" "></asp:TextBox>
              元<span class="Validform_checktip">格式0.00</span>
            </dd>
        </dl>
        <dl>
            <dt>产品种类</dt>
            <dd>
                <asp:TextBox ID="product_category" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
            <dt>辅石重</dt>
            <dd>
                <asp:TextBox ID="auxiliary_stone_weight" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" ">0.00</asp:TextBox>
                克<span class="Validform_checktip">数字</span>
            </dd>
        </dl>
        <dl>
            <dt>辅石数</dt>
            <dd>
                <asp:TextBox ID="side_stone_number" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
            <dt>证书号</dt>
            <dd>
                <asp:TextBox ID="certificate_no" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
                ...
                <dd>
                    <div class="rule-multi-checkbox">
                        <asp:CheckBoxList ID="finger_ring" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:CheckBoxList>
                    </div>
                </dd>
            </dl>
