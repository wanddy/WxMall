<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_lottery_lotterylist" Codebehind="lotterylist.aspx.cs" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th width="4%">选择</th>
    <th width="20%" align="left">活动名称</th>
    <th width="8%" align="left">活动开始时间</th>
    <th width="8%" align="left" >活动结束时间</th>
    <th width="8%" align="center" >是否显示奖品数量</th>
    <th width="8%" align="center" >参与总人数</th>
    <th width="8%">每天每人抽奖次数</th>
    <th width="8%">添加时间</th>
    <th width="4%" >操作</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    <td align="center">
      <asp:CheckBox ID="Check_Select" CssClass="checkall" runat="server" style="vertical-align:middle;" />
      <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
    </td>
    <td><%# Eval("lname")%></td>
    <td><%# Eval("stime")%></td>
    <td><%# Eval("etime")%></td>
    <td align="center"><%# Eval("isnum").ToString()=="1"?"是":"否"%></td>
    <td align="center"><%# Eval("total")%></td>
    <td align="center"><%# Eval("daynum")%></td>
    <td align="center" ><%# Convert.ToDateTime(Eval("updatetime")).ToString("yyyy-MM-dd")%></td>
    <td align="center">
