<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_message_linkedit" Codebehind="linkedit.aspx.cs" %>
...
<!--导航栏-->
<div class="location">
  <a href="linklist.aspx" class="back"><i></i><span>返回列表页</span></a>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
   ...
   <li><a href="javascript:;" onclick="tabs(this);" class="selected">更多信息</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  ...
  <dl>
    <dt>链接地址</dt>
    <dd>
       <asp:TextBox ID="linkUrl" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
    </dd>
  </dl>
  <dl>
    <dt>缩略图</dt>
    <dd>
     <input type="text" id="photoUrl" value=""  runat="server"/> <input type="button" id="image1" value="选择图片" /><br />
...
<div class="tab-content" style=" display:none;">
  <dl>
    <dt>英文名称</dt>
    <dd>
      <asp:TextBox ID="e_name" runat="server" CssClass="input normal" datatype="*0-100" 
            sucmsg=" " />
    </dd>
  </dl>
    ...
    <dt>英文内容</dt>
    <dd>
      <asp:TextBox ID="e_content" runat="server" CssClass="input normal" datatype="*0-100" 
            sucmsg=" " />
    </dd>
  </dl>
</div>
