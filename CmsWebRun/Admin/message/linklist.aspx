<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_message_linklist" Codebehind="linklist.aspx.cs" %>
    ...
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
         <li><a class="add" href="linkedit.aspx?action=add"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="linkedit.aspx?action=edit&id=<%#Eval("id")%>">编辑</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
