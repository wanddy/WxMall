<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_message_adedit" Codebehind="adedit.aspx.cs" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="linklist.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><i class="arrow">
        </i><span>编辑信息</span>
    </div>
    <div class="line10">
    </div>
    ...
    <div class="tab-content">
        <dl>
            <dt>广告类型</dt>
            <dd>
                <asp:DropDownList ID="adtype" runat="server" datatype="*" sucmsg=" " AutoPostBack="True">
                </asp:DropDownList>
            </dd>
        </dl>
        <dl>
            <dt>名称</dt>
            <dd>
                <asp:TextBox ID="name" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
            </dd>
        </dl>
        <dl>
            <dt>状态</dt>
        ...
        <dl>
            ...
            <dd>
                ...
                <img src="" alt="" id="picurl" runat="server" width="120" height="120" />
            </dd>
        </dl>
        <dl>
            <dt>排序</dt>
            <dd>
                <asp:TextBox ID="ordernum" runat="server" CssClass="input normal" datatype="n" sucmsg="请输入整数 "
                    Text="0" />
            </dd>
        </dl>
        <dl>
            <dt>内容</dt>
            <dd>
                <asp:TextBox ID="note" runat="server" CssClass="input normal" datatype="*0-10000"
                    sucmsg=" " Height="112px" Width="314px" TextMode="MultiLine" />
            </dd>
        </dl>
    </div>
    <!--/内容-->
