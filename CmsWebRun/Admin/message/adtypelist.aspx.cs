...
public partial class Admin_message_adtypelist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            string where = "select * from C_adtype  order by id desc";
            this.AspNetPager1.AlwaysShow = true;
            this.AspNetPager1.PageSize = 10;
            this.AspNetPager1.RecordCount = blladtype.GetRecordCount("");
    ...
    public void RepeaterDataBind(string whereStr)
    {
        ...
        ds = new DataSet();
        dr.Fill(ds, AspNetPager1.PageSize * (AspNetPager1.CurrentPageIndex - 1), AspNetPager1.PageSize, "C_adtype");
        this.rptList.DataSource = ds.Tables["C_adtype"];
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem item in rptList.Items)
        {
            ...
            if (check.Checked)
            {
                ...
                adminUser.AddAdminLog(DTEnums.ActionEnum.Delete.ToString(), blladtype.GetModel(id).name); //记录日志
                //删除文档的同时删除静态文档
                blladtype.Delete(id);
                
            }
        }
        JscriptMsg("删除信息成功！", "adtypelist.aspx", "Success");
    }
    #endregion
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        string whereStr = "select * from C_adtype where name like '%" + Keywords + "%' order by id desc";
