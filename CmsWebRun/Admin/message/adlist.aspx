<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_message_adlist" Codebehind="adlist.aspx.cs" %>
    ...
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
         <li><a class="add" href="adedit.aspx?action=add"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><%# Eval("ordernum")%></td>
     <td align="center"><%#getadtype(Convert.ToInt32(Eval("adtype")))%></td>
    <td align="center"><%# Eval("ishidden").ToString() == "0" ? "显示" : "隐藏"%></td>
    <td align="center"><%#string.Format("{0:g}", Eval("updateTime"))%></td>
  
    <td align="center"><a href="adedit.aspx?action=edit&id=<%#Eval("id")%>">编辑</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
