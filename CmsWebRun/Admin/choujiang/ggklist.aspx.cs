...
public partial class Admin_choujiang_ggklist : System.Web.UI.Page
{
    protected int totalCount;
    protected int page;
    protected int pageSize;
    Cms.BLL.wx_ggkActionInfo gbll = new Cms.BLL.wx_ggkActionInfo();
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                dr["url"] = MyCommFun.getWebSite() + "/shop/ggk/index.aspx?aid=" + dr["id"].ToString();
            }
            ds.AcceptChanges();
        }
