<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_choujiang_ggkEdit" Codebehind="ggkEdit.aspx.cs" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>开始活动的图片</dt>
                <dd>
                    <asp:Image ID="imgbeginPic" runat="server" ImageUrl="/shop/ggk/images/start.jpg" Style="max-height: 80px;" />
        ...
        <div class="tab-content" style="display: none">
            <dl>
                <dt>活动结束的图片</dt>
                <dd>
                    <asp:Image ID="imgEndPic" runat="server" ImageUrl="/shop/ggk/images/end.jpg" Style="max-height: 80px;" />
