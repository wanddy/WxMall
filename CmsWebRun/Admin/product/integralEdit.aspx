<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_product_integralEdit" Codebehind="integralEdit.aspx.cs" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="integralList.aspx" id="hreflist" runat="server" class="back"><i></i><span>返回列表页</span></a>
    ...
    <div class="tab-content" style="display: none">
        ...
        <dl style="">
            <dt>原积分</dt>
            <dd>
                <asp:TextBox ID="marketIntegral" runat="server" CssClass="input normal" datatype="n"
                    sucmsg=" ">0</asp:TextBox>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl style="">
            <dt>限量</dt>
            <dd>
                <asp:TextBox ID="limitNumber" runat="server" CssClass="input normal" datatype="n"
                    sucmsg=" ">0</asp:TextBox>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                <div class="rule-multi-radio">
                    <asp:RadioButtonList ID="typeId" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <asp:ListItem Value="0" Selected="True">限时</asp:ListItem>
                        <asp:ListItem Value="1">不限时</asp:ListItem>
                    </asp:RadioButtonList>
                </div>
            </dd>
        </dl>
         <dl>
            ...
            <dd>
                <div class="input-date">
                    <asp:TextBox ID="starTime" runat="server" CssClass="input date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                        datatype="/^\s*$|^\d{4}\-\d{1,2}\-\d{1,2}\s{1}(\d{1,2}:){2}\d{1,2}$/" errormsg="请选择正确的日期"
                        sucmsg=" " />
                    <i>日期</i>
                </div>
