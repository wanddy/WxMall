...
public partial class productlist : System.Web.UI.Page
{
    ...
    Cms.BLL.sc_Product bllorder = new Cms.BLL.sc_Product();
    public DataSet ds;
    ...
    public void Bind()
    {
        string where = "select * from sc_Product  order by id desc";
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        JscriptMsg("删除信息成功！", "productlist.aspx?parentId=" + strparentId, "Success");
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
       ...
       // if (skeyword.Length > 0)
        {
            string where = "select * from sc_Product  where title like '%" + skeyword + "%'  order by id desc";
            this.RepeaterDataBind(where.ToString());
        }
    }
   ...
   /// <param name="e"></param>
    ...
    {
        Response.Redirect("productedit.aspx?action=add");
    }
    ...
    protected void lbedit_Command(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("productedit.aspx?action=edit&id=" + id);
    }
