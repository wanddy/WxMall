...
public partial class Admin_product_integralEdit : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AjaxPro.Utility.RegisterTypeForAjax(typeof(Admin_product_integralEdit));//注册Ajax可调用的类的名称
        ...
        if (!Page.IsPostBack)
        {
            ...
            DropList_Bind();//绑定分类
            this.hreflist.HRef = "integralList.aspx";//设置返回列表链接
