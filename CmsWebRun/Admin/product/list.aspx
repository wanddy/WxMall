<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_product_list" Codebehind="list.aspx.cs" %>
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        </i><span>产品管理</span> <i class="arrow"></i><span>列表</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
    ...
    <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <%# new Cms.BLL.C_type().GetModel(Convert.ToInt32(Eval("typeId"))).title%>
                </td>
                <td>
