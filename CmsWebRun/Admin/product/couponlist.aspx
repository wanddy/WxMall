<%@ Page Language="C#" AutoEventWireup="true" Inherits="couponlist" Codebehind="couponlist.aspx.cs" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="center" width="12%">有效时间</th>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><%# typename(Eval("type_id").ToString())%></a></td>
    <td align="center"><%#Eval("cname")%></a></td>
    <td align="center"><%#Convert.ToDecimal(Eval("cmoney")).ToString("0.00")%></a></td>
    <td align="center"><%#Eval("number")%></td>
    <td align="center"><%#Convert.ToDateTime(Eval("stime")).ToString("yyyy/MM/dd")%>-<%#Convert.ToDateTime(Eval("etime")).ToString("yyyy/MM/dd")%></td>
