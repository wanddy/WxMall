...
public partial class Admin_wxRule_wenBenList : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
       ...
       adminUser.AddAdminLog(Enums.ActionEnum.Delete.ToString(), "删除文本回复信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志
