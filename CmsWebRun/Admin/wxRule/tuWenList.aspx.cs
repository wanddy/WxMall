...
public partial class Admin_wxRule_tuWenList : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        _strWhere = "wId=1 and reqestType=1 and responseType=2 and ruleName='图文回复' and (modelFunctionName is null or modelFunctionName='') " + _strWhere;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
       ...
       adminUser.AddAdminLog(DTEnums.ActionEnum.Delete.ToString(), "删除图文回复信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志
